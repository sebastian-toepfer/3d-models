...
difference() {
    union() {
        cube([breite_innen + wandstaerke * 4, tiefe_innen + wandstaerke * 4, wandstaerke * 2], center = true);

        mirror_copy([0, 1, 0]) {
            mirror_copy() {
                translate([breite_innen / 4, (tiefe_innen + wandstaerke * 4) / 2, wandstaerke * 2]) {
                    difference() {
    ...
    translate([0, 0, wandstaerke]) {
        cube([breite_innen + wandstaerke * 2, tiefe_innen + wandstaerke * 2, wandstaerke * 2], center = true);
    }
