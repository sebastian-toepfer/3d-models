...
bool digital_output_pin_test_has_event(const digital_pin_event_log_t *eventslog, digital_pin_event_t event);
size_t digital_output_pin_test_index_of_event(const digital_pin_event_log_t *eventslog, digital_pin_event_t event);
size_t digital_output_pin_test_count_events(const digital_pin_event_log_t *eventslog, digital_pin_event_type_t type);
